...
public class Frag_user extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (MainActivity.username == null)
            ...
            Log.d("Frag_user:","user name is:"+info.get("username"));
            Log.d("Frag_user:","user age is:"+info.get("age"));
           ...
           // photo = getActivity().findViewById(R.id.user_photo);
            ...
            logoutButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    // 更新界面为未登录状态
                    // 你可以通过替换当前的 Fragment 为一个未登录状态的 Fragment 来实现这一点，
                    // 或者你可以通过其他方式（比如重新启动你的 Activity）来实现这一点。
                    // 这里是一个简单的示例，你可能需要根据你的实际情况进行修改：
                    getFragmentManager().beginTransaction().replace(R.id.frag, new Frag_user()).commit();
                }
            });
          ...
          /*  set_photo = getActivity().findViewById(R.id.set_photo);
            ...
            Button addNewsButton = getView().findViewById(R.id.add_news_button);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // Handle the result from AddNews activity
        if (requestCode == REQUEST_CODE_ADD_NEWS && resultCode == Activity.RESULT_OK) {
            Bundle bundle = data.getExtras();
            if (bundle != null && bundle.getInt("flag") == 1) {
                // Create a new News_bean object from the bundle
                ...
                // Add the news
                ((MainActivity) getActivity()).handleaddNews(news);
            }
        }

        // Handle the result from the album
